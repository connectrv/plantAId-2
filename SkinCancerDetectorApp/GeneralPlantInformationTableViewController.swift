...
class GeneralPlantInformationTableViewController: UITableViewController {
    ...
    func addGeneralInformation(toCell cell: inout UITableViewCell, forIndexPathRow row: Int) {
        ...
        cell.textLabel?.textColor = #colorLiteral(red: 0.915420711, green: 0.5387170911, blue: 0.1502360404, alpha: 1)
        cell.detailTextLabel?.textColor = #colorLiteral(red: 0.915420711, green: 0.5387170911, blue: 0.1502360404, alpha: 1)
...
extension GeneralPlantInformationTableViewController {
    ...
    func getNewName(for plantName: PlantName) {
        let alertTitle = "Change the plant's \(plantName == .commonName ? "common name" : "disease name")"
