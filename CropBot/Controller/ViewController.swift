...
class ViewController: UIViewController {
    ...
    */
    ...
    var humidity1 = "41% humidity, "
    var weather1 = "71 degrees Fahrenheit, and"
    var plantcheck = " today is an ideal day to plant crops."
...
//        ChatLink(link: "www.google.com", isIncoming: false)
    ...
    */
    let inputTextField: UITextField = {
        ...
        textField.placeholder = "Ask DisasterBot"
    ...
    */
    func setupNavigationItem() {
        // Title
        navigationItem.title = "Ask DisasterBot"
    ...
    */
    func sendDailyUpdate() {
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            self.handleSend(message: ChatText(text: "Hello, here is your daily update: " + self.humidity1 + self.weather1 + self.plantcheck, isIncoming: true))
